  ...
  return (
    <>
      <div className="whatwe-container sm:w-[600] mr-[90px]">
        ...
        <div className="flex what-we-backup">
          <div className=" whatwe-body ">
            <span>
              ...
              <h1 className="ml-7">Insurance Tech</h1>
            </span>

            <p>We are using deep learning trained artificial inteligence (AI) to handle the tasks of insurance brokers and find the right mix of policies to complete an individuals or Group coverage.</p>
            ...
            <span>
              ...
              <h1 className="ml-7">Software Development</h1>
            </span>
            <p>We are positioned to help business take advantage of emerging technologies as well as the ability to absorb the technology while also performing corresponding research and development and training activities.</p>
          </div>
          <div className=" whatwe-body">
            <a className="flex  whatwe-a" href="https://relief.nubeero.com/">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  opacity="0.4"
            ...
            <p>Maximize your business's operations with innovative and trusted merchant services, payment processing services and solutions.</p>
            <span>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  opacity="0.4"
                  ...
                  strokeLinejoin="round"
                />
                <path d="M7 4.5C7 5.88 5.88 7 4.5 7C4.33 7 4.16 6.98 4 6.95C2.86 6.72 2 5.71 2 4.5C2 3.12 3.12 2 4.5 2C5.71 2 6.72 2.86 6.95 4C6.98 4.16 7 4.33 7 4.5Z" stroke="#00325c" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path
              ...
              <h1 className="ml-7">Intermediation</h1>
            </span>
            <p>We are an expected Enterprise Solutions delivery company with proven track records in various sectors, including Digital Insurance Solutions, Commercial banking,Digital Banking, Agency Banking...</p>
          </div>
        </div>
      </div>
    </>
