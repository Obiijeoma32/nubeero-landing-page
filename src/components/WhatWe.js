    ...
    <>
      <div id="what" className="whatwe-container sm:w-[600] mr-[90px]">
        <div className="whatwe-header">
          <h1>What We Do</h1>
          <p>
            We provide innovative solutions for insurance, business process
            optimization & ecommerce service. Our promise is that we are growth
            enablers,serving the needs of the industries in which we play.
          </p>
        </div>
        <div className="flex what-we-backup">
          <div className=" whatwe-body ">
            ...
            <p>
              We are using deep learning trained artificial inteligence (AI) to
              handle the tasks of insurance brokers and find the right mix of
              policies to complete an individuals or Group coverage.
            </p>
            ...
            <p>
              We are positioned to help business take advantage of emerging
              technologies as well as the ability to absorb the technology while
              also performing corresponding research and development and
              training activities.
            </p>
          </div>
          <div className=" whatwe-body">
            <a
              className="flex  whatwe-a"
              href="#"
              onClick={(e) => {
                e.preventDefault();
              }}
            ...
            <p>
              Maximize your business's operations with innovative and trusted
              merchant services, payment processing services and solutions.
            </p>
            <span>
              <svg
                width="24"
            ...
            <p>
              We are an expected Enterprise Solutions delivery company with
              proven track records in various sectors, including Digital
              Insurance Solutions, Commercial banking,Digital Banking, Agency
              Banking...
            </p>
          </div>
        </div>
