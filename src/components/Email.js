  ...
  return (
    <>
      <div className="email-container">
        <h1>Contact Us</h1>
        <p>Got a question or comment? Get in touch with us</p>
        <div>
          <form autoComplete="on" className="email-form" action="mailto:info@nubeero.com">
            ...
            <br />
            <input type="email" placeholder="ex:janedoe000@mail.com" />
            <br />
        ...
        <div className="email-link-div">
          <div className="email-link">
            <Link to="/onboarding">SEND MESSAGE</Link>
          </div>
        </div>
        <div className="email-footer">
          <h2>EMAIL US</h2>
          <div className="flex email-footer-link">
            <h3>support@nubeero.com</h3>
            ...
            <a href="https://www.instagram.com/nubeero_ng/" title="Instagram">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  ...
                  fill="currentColor"
                />
                <circle cx="16.9121" cy="5.08749" r="0.732875" fill="white" />
              </svg>
            </a>
