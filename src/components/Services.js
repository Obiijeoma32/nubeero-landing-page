      ...
      <div className="services-container">
        ...
        <div className="flex mt-20 services-body">
          ...
          <div className="services-content">
            ...
            <p>
              We pull disparate policies into one platform for management and monitoring, creating on-demand insurance for micro-events like borrowing a friend's car, and the adoption of the peer-to-peer model to both create customized group coverage
              and incentivize positive choices through group rebates.
            </p>
          </div>
        </div>
      </div>
